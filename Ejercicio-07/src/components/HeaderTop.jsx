...
export default function HeaderTop() {
  ...
  return(
    // <!-- Header Top -->
    <div className="header-top d-flex flex-column flex-lg-row align-items-center justify-content-between gap-3 position-relative p-4">

      {/* <!-- Marca --> */}
      <div className="logo flex-shrink-0 mx-lg-3">
        <h3 className="fw-bolder">ZapaShop</h3>
      </div>
      ...
      <div className="header-icons d-flex gap-3 flex-shrink-0 px-2 align-items-center">
        ...
        {!isAuth ? (
          ...
          >
            ...
            <span className="fs-6 ps-3">Ingreso/nueva</span>
          </Link>
        ) : (
        ...
        <Link to="/carrito" className="overlink text-decoration-none text-reset d-flex align-items-center">
          <i className="icarrito bi bi-bag position-relative fs-5">     
            <Badge 
              bg="danger"
              pill
